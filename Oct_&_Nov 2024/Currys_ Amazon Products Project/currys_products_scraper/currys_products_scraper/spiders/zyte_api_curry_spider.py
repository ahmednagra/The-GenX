...
class CurrySpider(Spider):
    ...
    # fields = ['SKU', 'Title', 'Brand', 'Price', 'Price Currency', 'Availability',
    ...
    def start_requests(self):
        ...
        for keyword in self.search_keywords[:1]:
            ...
            # test
            # url = 'https://www.currys.co.uk/products/samsung-galaxy-book4-pro-14-laptop-intel-core-ultra-7-512-gb-ssd-grey-10259995.html'
            # yield Request(url, callback=self.parse_product_detail, meta={'Keyword': keyword, 'handle_httpstatus_all': True})
    ...
    def parse_product_detail(self, response):
        ...
        try:
            ...
            # yield JsonRequest(url=self.api_url, data=item, method="POST", callback=self.handle_post_response,
            #                   errback=self.handle_post_error, headers={'Content-Type': 'application/json'})
