...
class RetailerSpider(Spider):
    ...
    def start_requests(self):
        ...
        for keyword in self.search_keywords:
            ...
            url1 = f'https://www.amazon.co.uk/s?k=windows%20laptops'
            url = f'https://www.amazon.co.uk/s?k={keyword}'
            url = quote(url)
            yield SeleniumRequest(url=url, callback=self.parse_categories, meta={'page': 'Indexing Page'})
    ...
    def get_search_keywords_from_file(self):
        return self.get_input_from_txt(glob.glob('input/amazon_search_keywords.txt')[0])
