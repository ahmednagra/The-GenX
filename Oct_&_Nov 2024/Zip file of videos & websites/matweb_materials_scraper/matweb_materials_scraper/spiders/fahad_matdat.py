...
#cleaning the spider for Fahad Bhai
class MatdatSpider(BaseSpider):
    ...
    def parse_detail(self, response):
        ...
        try:
            ...
            item['Collecting Cyclic Stress-Strain Plot Data'] = self.get_coll_strain_plot(response)
            item['Collecting Strain-Life Fatigue Plot Data'] = self.get_coll_fatigue_plot_data(response)
    ...
    def get_coll_strain_plot(self, response):
        ...
        return cycle_strain_stress_chart_url

    def  get_coll_fatigue_plot_data(self, response):
        ...
        return collecting_strain_fatigue_plot_url
