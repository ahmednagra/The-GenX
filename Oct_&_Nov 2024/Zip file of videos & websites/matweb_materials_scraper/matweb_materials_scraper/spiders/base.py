...
class BaseSpider(Spider):
    ...
    fields = [
        ...
        'Monotonic Properties', 'Monotonic Stress-Strain Curves (Ramberg-Osgood Model)', 'Cyclic/Fatigue Properties (Axial Loading, Fully Reversed)',
        ...
        'Collecting Cyclic Stress-Strain Plot Data'
    ]
