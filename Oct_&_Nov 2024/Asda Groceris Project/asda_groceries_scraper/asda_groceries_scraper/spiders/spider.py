...
class AsdaGroceriesSpider(Spider):
        ...
        'FEEDS': {
            ...
            f'output/Asda Groceries Scraper {current_dt}.json': {
                ...
                'fields': ['retailer_id', 'retailer_name', 'retailer_country', 'retailer_category',
                           'standard_category', 'retailer_website', 'category_id',
    ...
    def start_requests(self):
        ...
        for cat in categories[:1]: #test
            cat = 'Chilled Food' #test
    ...
    def pagination(self, response, **kwargs):
        ...
        if product_listing:
            ...
            for item in listing_items[:1]: #test
                # item_id = item.get('item_id', '')
                # item_id = ['394988' #2 offer. 31545310 3 offer 1000383206830 buy 6 save 25%, 1000383210534 4 for 3
                item_ids = ['394988' , '31545310', '1000383206830', '1000383210534'] # test
                for item_id in item_ids: #test
    ...
    def parse_detail(self, response):
        ...
        try:
            ...
            item = OrderedDict()
            item['retailer_id'] = 'None'
            item['retailer_name'] = 'ASDA'
            item['retailer_country'] = 'None'
    ...
    def get_promotion_discount(self, listing_items):
        ...
        try:
            ...
            if linksave:
                ...
                # Calculate promotion discount and price save
                # prom_disc = math.ceil(promo_value / promo_quantity) if promo_value>promo_quantity else 0
                # price_save_value = promo_value - promotion_price
                # price_save = f'Save £{price_save_value}' if price_save_value>0 else None
